...
var eventjoy = (function () {
	...
	ej.event_attendee = function(event_id, email, params, complete) {
		(new _apiRequest('events/'+event_id+'/attendees/email'+email, complete)).execute('GET', {'X-API-Key': _API_KEY, 'access_token': _ACCESS_TOKEN}, params);
	};
